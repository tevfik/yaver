...
class TestCodeAnalyzerIntegration:
    ...
    def analyzer(self):
        ...
        with patch("src.tools.code_analyzer.analyzer.CodeEmbedder"), patch(
            "src.tools.code_analyzer.analyzer.Neo4jAdapter"
        ), patch("src.tools.code_analyzer.analyzer.QdrantAdapter"):
