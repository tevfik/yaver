...
def test_analyze_function_change_simple(mock_driver):
    ...
    mock_record.__getitem__.side_effect = lambda x: {"id": "caller1", "name": "test_caller", "file": "/src/caller.py", "line": 10}.get(x)
    ...
    mock_driver.session().run.side_effect = [mock_node_result, mock_callers_result, mock_transitive_result]
