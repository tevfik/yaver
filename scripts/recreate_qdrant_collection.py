...
def recreate_collection():
    ...
    if "nomic" in ollama_config.model_embedding.lower():
        ...
        print(
            f"⚠️  Unknown model '{ollama_config.model_embedding}'. Defaulting to vector size: {vector_size}"
        )
        print(
            f"    If this is wrong, edit this script or manually specify vector size."
        )
